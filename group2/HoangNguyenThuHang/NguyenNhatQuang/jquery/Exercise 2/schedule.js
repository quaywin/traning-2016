...
displaySchedule();
$("#show-track-1").bind("click", function(){
        displaySchedule();
});

$("#show-track-2").bind("click", function(){
     displaySchedule();
});
...
function displaySchedule() {
    ...
    if(track1Checkbox.checked && track2Checkbox.checked){
        for (var i = 0; i < schedule.length; i++) {
            // if(schedule[i].tracks[0] == 1 && schedule[i].tracks[1] == 2){
    ...
    else if(track1Checkbox.checked){
        for (var i = 0; i < schedule.length; i++){
    ...
    else if(track2Checkbox.checked){
        for (var i = 0; i < schedule.length; i++){
